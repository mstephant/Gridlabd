function [timeswing, powers_A_real, powers_A_reac, powers_B_real,...
    powers_B_reac,powers_C_real, powers_C_reac] = prod_swing_import(foldername_swing)


% import the data for the production from the file contained in the folder 
% this folder shoudl contain only the only file that you want to import
...
%% Code 
    ...
    for i = 1:length(time)
      timeswing(i) = etime(time(i,:),time(1,:));
    end     
